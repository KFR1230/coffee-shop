...
const CurrentOrder = ({ ...props }) => {
  ...
  return (
    <>
      <div className="p-4 w-full h-3/4 overflow-y-auto mx-auto sm:mb-4 sm:p-4 rounded-2xl">
      ...
      <div className="h-1/5 flex justify-between items-center w-full p-4  mx-auto rounded-2xl">
