  ...
  return (
    <>
      <div className="h-full mt-6 p-3 grid border ring-2 ring-black/50 text-slate-800 border-solid rounded-2xl items-center grid-cols-4 gap-x-6 gap-y-10 xl:gap-x-8 max-sm:gap-x-2">
        ...
        {!isSold && (
          <button className="cursor-not-allowed mx-2 justify-self-center flex justify-center items-center min-w-min w-14 h-10 rounded-xl bg-gray-500/70 max-sm:w-10 max-sm:h-6 max-sm:rounded-md  ring-2 ring-black/50 transform transition-all">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
